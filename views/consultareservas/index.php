    ...
    <div id="main">
        ...
        ?>
                <tr id="fila-<?php echo $reserva->idRESERVAS; ?>">
                    ...
                    <td><input type="button" class="btn btn-primary" onclick="window.location='<?=constant('URL') . 'consultareserva/verReserva/'. $reserva->idRESERVAS; ?>'" value="Actualizar"/></td> 
                    <td><button class="btn btn-danger bEliminar" data-idRESERVAS="<?php echo $reserva->idRESERVAS; ?>">Eliminar</button></td> 
                </tr>
        <?php } ?>
            </tbody>
        </table>
