    ...
    <div id="main">
        ...
        ?>
                <tr id="fila-<?php echo $persona->Cedula; ?>">
                    ...
                    <td><input type="button" class="btn btn-primary" onclick="window.location='<?=constant('URL') . 'consulta/verPersona/'. $persona->Cedula; ?>'" value="Actualizar"/></td> 
                    <td><button class="btn btn-danger bEliminar" data-cedula="<?php echo $persona->Cedula; ?>" >Eliminar</button></td>
                </tr>
        <?php } ?>
            </tbody>
        </table>
